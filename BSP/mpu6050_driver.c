...
/**************************实现函数********************************************
*函数原型:		void MPU6050_a_DataSave(float ax,float ay,float az)
*功　　能:	  MPU6050数据处理，取平均值，将MPU6050_ax,MPU6050_ay, MPU6050_az处理后存储
*******************************************************************************/
...
/**************************实现函数********************************************
*函数原型:		void MPU6050_wa_DataSave(float ax,float ay,float az)
*功　　能:	  MPU6050数据处理，取平均值，将MPU6050_wax,MPU6050_way, MPU6050_waz处理后存储
*******************************************************************************/
...
/**************************实现函数********************************************
*函数原型:		void MPU6050_wa_DataSave(float ax,float ay,float az)
*功　　能:	  MPU6050数据处理，取平均值，将MPU6050_wx,MPU6050_wy, MPU6050_wz处理后存储
*******************************************************************************/
